...
import net.sf.nmedit.jpatch.clavia.nordmodular.v3_03.event.Listenable;
...
public class MorphSet extends AbstractList<Morph> implements Listenable<MorphEvent>
{
    ...
    /**
     * @see net.sf.nmedit.jpatch.clavia.nordmodular.v3_03.event.ListenableAdapter#fireEvent(T)
     */
