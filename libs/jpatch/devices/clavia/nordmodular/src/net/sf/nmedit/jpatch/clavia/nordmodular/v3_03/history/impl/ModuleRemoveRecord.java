...
public class ModuleRemoveRecord extends HistoryRecordImpl
{
    ...
    public ModuleRemoveRecord( PatchHistoryImpl history, HistoryRecordTypeImpl type, Module module )
    {
        this( history, type, module.getIndex(), module.getDefinition(), module.getVoiceArea().isPolyVoiceArea() );
    }
    
    public ModuleRemoveRecord( PatchHistoryImpl history, HistoryRecordTypeImpl type, int index, DModule def, boolean polyVA )
    {
        super( history, type );
        this.index = index;;
        this.definition = def;
    ...
    {
        return new ModuleAddRecord(history, (HistoryRecordTypeImpl) type.getOpposite(), index, definition, polyVA);
    }
