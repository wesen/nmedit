...
public class XMLProcessingException extends Exception
{
    ...
    public XMLProcessingException( XmlPullParser parser, String message )
    {
        super ( formatMessage(parser, message) );
    }

    private static String formatMessage( XmlPullParser parser, String message )
    {
        return
