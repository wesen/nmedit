...
import net.sf.nmedit.jtheme.clavia.nordmodular.ADDisplay;
...
public class ADEnvelopeStore extends AbstractEnvelopeStore
{
    ...
    protected ADEnvelopeStore(Element element)
    {
        super(element);
    }
    ...
    {
        return new ADEnvelopeStore(element);
    }

    @Override
    public JTComponent createComponent(JTContext context) throws JTException
    {
        JTComponent component = context.createComponentInstance(ADDisplay.class);
        applyName(component);
