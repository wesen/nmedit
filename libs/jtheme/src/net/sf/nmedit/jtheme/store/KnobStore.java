...
public class KnobStore extends ControlStore
{

    protected KnobStore(Element element)
    {
        super(element);
    }

    public static KnobStore create(StorageContext context, Element element)
    {
        return new KnobStore(element);
    }
