 ...
 */
package net.sf.nmedit.jtheme.component.swing;
...
public class JTLazyActionMap extends ActionMapUIResource
{
    /**
            ...
            JComponent c, Class loaderClass, String defaultsKey)
    {
        ...
        if (map == null)
        {
            map = new JTLazyActionMap(loaderClass);
    ...
    private JTLazyActionMap(Class loader)
    {
        _loader = loader;
    }
        ...
        if (_loader != null)
        {
            ...
            try
            {
                Method method = klass.getDeclaredMethod("loadActionMap",
                        new Class[] { JTLazyActionMap.class });
