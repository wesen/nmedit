...
import net.sf.nmedit.jsynth.clavia.nordmodular.v3_03.io.BitStreamEncoder;
import net.sf.nmedit.jsynth.clavia.nordmodular.v3_03.io.BitStreamTarget;

public class BitStreamEncoderProvider extends PatchEncoderProvider
{
    ...
    {
        return new BitStreamEncoder(impl);
    }

    @Override
    public boolean isSupported( Class<? extends Target> target )
    {
        return BitStreamTarget.class.isAssignableFrom(target);
    }
