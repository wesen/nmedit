...
public class Module008 extends Module {
	...
	public Module008(Integer newIndex, int newType, int newX, int newY, Modules newModulesRef, boolean newPoly, JModAreaPane newDesktopPane) {
        ...
        pw = new JModKnob(JModKnob.SMALL, false, true, 194, 26, 0, 127, moduleData.getParameter(7));
        
        pitch1 = new JModKnob(JModKnob.SMALL, false, true, 24, 69, 0, 127, moduleData.getParameter(4));
        pitch2 = new JModKnob(JModKnob.SMALL, false, true, 74, 69, 0, 127, moduleData.getParameter(5));
        
        fma = new JModKnob(JModKnob.SMALL, false, true, 124, 69, 0, 127, moduleData.getParameter(6));

        mute = new JModToggleButton(221, 77, 15, 15, "M", moduleData.getParameter(8));

        sqr = new JModRadioButton(223, 15, 27, 15, "Sqa", -1, 3, moduleData.getParameter(3));
        tri = new JModRadioButton(223, 28, 27, 15, "Saw", -1, 2, moduleData.getParameter(3));
        sin = new JModRadioButton(223, 41, 27, 15, "Tri", -1, 1, moduleData.getParameter(3));
        saw = new JModRadioButton(223, 54, 27, 15, "Sin", -1, 0, moduleData.getParameter(3));
