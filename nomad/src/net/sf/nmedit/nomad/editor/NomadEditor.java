...
public class NomadEditor
{

    public static void main( String[] args )
            throws ApplicationInstantiationException
    {
        Application.setProperty(Const.APPLICATION_CLASS_NAME, "net.sf.nmedit.nomad.editor.NomadEditorApplication");
        Application.setProperty(Const.APPLICATION_NAME, "Nomad Editor");
        Application.setProperty(Const.APPLICATION_VERSION, "0.1a");
        Application.setProperty(Const.APPLICATION_LOGFILE, "nomad-editor.log");
