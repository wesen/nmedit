 ...
 */
package net.sf.nmedit.nomad.editor.views.property;
...
import net.sf.nmedit.nomad.theme.property.editor.EditorEvent;
import net.sf.nmedit.nomad.theme.property.editor.EditorListener;


class EditWindowDialog extends JDialog implements ActionListener, EditorListener {
	...
	public EditWindowDialog(JFrame frame, NomadComponent component, Editor e) {
		super(frame, "Editor:"+e.getProperty().getName());
		this.component = component;
		//this.editor = editor;
	//	this.property = property;
		propertyEditor = e;//property.newEditor(component);

		getContentPane().setLayout(new BorderLayout());
		getContentPane().add(e.getEditorComponent(), BorderLayout.CENTER);
