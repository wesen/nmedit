...
import net.sf.nmedit.nomad.synth.nord.protocol.ProtocolImpl;

public class NordModular extends AbstractNordModularDevice
{
    ...
    @Override
    Protocol createProtocol( ) throws DeviceIOException
    {
